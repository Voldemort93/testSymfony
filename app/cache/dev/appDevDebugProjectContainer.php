...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getBuzzService()
    {
        ...
        return $this->services['buzz'] = new \Buzz\Browser($a, new \Buzz\Message\Factory\Factory());
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'symfony', 'user' => 'root', 'password' => 63792933, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/AppBundle/Entity'), 1 => ($this->targetDirs[3].'/src/dbBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'AppBundle\\Entity');
        $c->addDriver($b, 'dbBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('AppBundle' => 'AppBundle\\Entity', 'dbBundle' => 'dbBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_3f5f69654f517cb03be6815a4f79c8e839440fd00f3874ffcc6f8d3d7e198ade');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Vova/HelloBundle/Resources/views'), 'VovaHello');
        $instance->addPath(($this->targetDirs[3].'/src/dbBundle/Resources/views'), 'db');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('ef22f2da4f0dfb11211cc7984e9bfa3b5174625b');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56bf05d8d3df05.39050319')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'VovaHelloBundle' => 'Vova\\HelloBundle\\VovaHelloBundle',
                'SensioBuzzBundle' => 'Sensio\\Bundle\\BuzzBundle\\SensioBuzzBundle',
                'dbBundle' => 'dbBundle\\dbBundle',
            ...
            'database_user' => 'root',
            'database_password' => 63792933,
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => 'ef22f2da4f0dfb11211cc7984e9bfa3b5174625b',
            'locale' => 'en',
            ...
            'kernel.secret' => 'ef22f2da4f0dfb11211cc7984e9bfa3b5174625b',
